...
-- Insertar usuario de prueba (sin OAuth2, solo para demostración local)
INSERT INTO usuario (oauth2_provider, email, nombre, foto, fecha_creacion, fecha_actualizacion) VALUES
('TEST', 'test@example.com', 'Usuario de Prueba', 'https://via.placeholder.com/150', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
